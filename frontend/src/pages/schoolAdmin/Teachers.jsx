...
export default function Teachers() {
    ...
    const handleDeleteTeacher = async (id) => {
        ...
        try {
            ...
            setBtnLoading(null);
            // console.log("error from Teachers.jsx => ", error.message);
        } finally {
            setBtnLoading(null);
        }
    }

    const handleEditTeacher = async (t) => {
        setAddModal(true);
            ...
            render: (t) => (
                <div className="flex items-center gap-1">
                    ...
                    <IconButton
                        ...
                        disab
                        loading={btnLoading === t._id}
                        onClick={() => handleDeleteTeacher(t._id)} />
                </div>
            ),
        },
    ], [btnLoading, handleDeleteTeacher, handleEditTeacher])
    ...
    return (
        <div className="space-y-6">
            ...
            <Modal isOpen={addModal} onClose={() => setAddModal(false)} title="Add New Teacher">
                <AddTeacherForm onClose={() => setAddModal(false)} refetch={refetch} selectedTeacher={selectedTeacher} />
            </Modal>
        </div>
    );
}